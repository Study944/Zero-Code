...
import com.zerocode.langGraph4j.image.app.PlanCodeGenWorkflow;
...
public class WorkflowSseController {
    ...
    public WorkflowContext executeWorkflow(@RequestParam String prompt) {
        ...
        return new PlanCodeGenWorkflow().executeWorkflow(prompt);
    }
    ...
    public Flux<String> executeWorkflowWithFlux(@RequestParam String prompt) {
        ...
        return new PlanCodeGenWorkflow().executeWorkflowWithFlux(prompt);
    }
}
