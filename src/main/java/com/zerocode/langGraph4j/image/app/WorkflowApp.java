...
import com.zerocode.langGraph4j.image.node.RouterNode;
import com.zerocode.langGraph4j.image.state.WorkflowContext;
import com.zerocode.langGraph4j.image.node.CodeGeneratorNode;
import com.zerocode.langGraph4j.image.node.ImageCollectorNode;
import com.zerocode.langGraph4j.image.node.ProjectBuilderNode;
import com.zerocode.langGraph4j.image.node.PromptEnhancerNode;
...
public class WorkflowApp {
    ...
    public static void main(String[] args) throws GraphStateException {
        ...
        WorkflowContext initialContext = WorkflowContext.builder()
                .originalPrompt("创建一个ZXC的个人编程网站，代码控制在200行")
                .currentStep("初始化")
                .build();
